    ...
    <main style={{ background: "#080c12", minHeight: "100vh", color: "#fff", fontFamily: "'Helvetica Neue', Helvetica, Arial, sans-serif" }}>
      ...
      <style>{`
        @media (max-width: 768px) {
          ...
          .mobile-cta { display: inline-block !important; background: #fff; color: #080c12; padding: 8px 16px; borderRadius: 6px; fontSize: 13px; fontWeight: 600; textDecoration: none; }
        }
      `}</style>
